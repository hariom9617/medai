  ...
  return (
    <AppLayout title="Doctor Dashboard">
      <PageHeader
        ...
        subtitle="AI-powered overview of your patient panel"
      />
      ...
      {patientsLoading ? (
        ...
        <>
          ...
          <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
            <div className="lg:col-span-2">
              <SectionCard
                ...
                action={
                  <span className="text-xs text-slate-500">Panel-wide</span>
                }
              >
            ...
            <SectionCard title="Recent Interventions" className="lg:col-span-1">
              <ul className="space-y-3">
                <li className="text-sm text-slate-500">
                  Intervention history will be available after backend
                  implementation
                </li>
              </ul>
            </SectionCard>
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <button
              onClick={() =>
                toast.success("Intervention sent to top high-risk patient")
              }
            ...
            <button
              onClick={() => toast.success("Caregiver team notified")}
